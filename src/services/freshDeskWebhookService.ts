...
import { extractMagentoId } from '../utils/extractMagentoId';
...
Responda ao cliente de forma natural e contextualizada.`;
   ...
   */
  public async getTicketData(ticketId: number): Promise<FreshDeskTicket | null> {
